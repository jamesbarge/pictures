...
**PR**: #TBD | **Files**: `src/lib/scrape-run-summary.ts` (new), `src/lib/scrape-run-summary.test.ts` (new), `src/scripts/run-scrape-and-enrich.ts`, `src/lib/scrape-quarantine.ts`, `.claude/commands/scrape.md`
