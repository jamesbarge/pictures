...
- **Format established before any change.** A bounded read-only capture (2026-09-10, HTTP 200, full-page sha256 recorded) shows AudienceView column [8] is a zero-padded 24-hour local clock: hour histogram across all 91 rows `{9:12,10:6,11:3,13:13,14:8,15:1,17:17,18:5,19:2,20:19,21:2,22:1,23:2}`. Hours reach **23**, sub-ten values are written `09:00` never `9:00`, and no am/pm text appears — so a 12-hour reading is excluded and `09:00` is unambiguously morning. The 12 rejections were false positives.
