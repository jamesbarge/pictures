...
export default function FilmNotFound() {
  return (
    <div className="min-h-screen bg-background-primary flex flex-col items-center justify-center px-4">
      ...
      <Link
        href="/"
        className="inline-flex items-center gap-2 px-4 py-2 bg-accent-gold text-background-primary font-medium rounded-lg hover:bg-accent-gold/90 transition-colors"
      >
