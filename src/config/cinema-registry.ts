...
const INDEPENDENT_CINEMAS: CinemaDefinition[] = [
  ...
  },
  {
    ...
    chain: null,
    scraperType: "cheerio",
    scraperModule: "cinemas/nickel-v2",
  ...
  },
  {
    ...
    address: { street: "307 Regent Street", area: "Marylebone", postcode: "W1B 2HW", borough: "Westminster" },
    ...
    description: "Birthplace of British cinema (1896). Only UK cinema with 16mm/35mm/Super8/4K projection.",
  ...
  },
  {
    ...
    chain: null,
    scraperType: "api",
    scraperModule: "cinemas/chiswick",
    scraperFactory: "createChiswickScraper",
    active: true,
    features: ["accessible", "bar", "cafe"],
    programmingFocus: ["mainstream", "arthouse", "events"],
    description: "Boutique five-screen cinema on Chiswick High Road (opened 2021). INDY platform.",
  ...
  },
  {
    ...
    address: { street: "341-351 Finchley Road", area: "Finchley Road", postcode: "NW3 6ET", borough: "Camden" },
    coordinates: { lat: 51.5436, lng: -0.1769 },
    screens: 1,
    chain: null,
    scraperType: "cheerio",
    scraperModule: "cinemas/jw3",
    scraperFactory: "createJW3Scraper",
    active: true,
    features: ["arts-centre", "community", "accessible"],
    programmingFocus: ["jewish-cinema", "world-cinema", "documentary"],
    description: "Jewish community centre on Finchley Road with a single-screen cinema (Spektrix ticketing).",
    bookingUrl: "https://www.jw3.org.uk/cinema-at-jw",
  },
  {
    id: "close-up-cinema",
  ...
  },
  {
    ...
    shortName: "DocHouse",
    website: "https://dochouse.org",
    address: { street: "The Brunswick", area: "Bloomsbury", postcode: "WC1N 1AW", borough: "Camden" },
    coordinates: { lat: 51.5247, lng: -0.1235 },
    screens: 1,
    chain: null,
    scraperType: "cheerio",
    scraperModule: "cinemas/bertha-dochouse",
    scraperFactory: "createBerthaDochouseScraper",
    active: true,
    features: ["bar", "accessible"],
    programmingFocus: ["documentary"],
    description: "UK's only year-round documentary cinema, inside Curzon Bloomsbury but programmed independently.",
    bookingUrl: "https://dochouse.org/whats-on/",
  },
  {
    id: "cinema-museum",
    name: "The Cinema Museum",
    shortName: "Cinema Museum",
    website: "https://cinemamuseum.org.uk",
    address: { street: "2 Dugard Way", area: "Kennington", postcode: "SE11 4TH", borough: "Lambeth" },
    coordinates: { lat: 51.4926, lng: -0.1075 },
    screens: 1,
    chain: null,
    scraperType: "cheerio",
    scraperModule: "cinemas/cinema-museum",
    scraperFactory: "createCinemaMuseumScraper",
    active: true,
    features: ["historic", "accessible"],
    programmingFocus: ["silent", "repertory", "talks", "events"],
    description: "Volunteer-run venue in the former Lambeth workhouse; 35mm, silent, repertory + Kennington Bioscope evenings.",
    bookingUrl: "https://cinemamuseum.org.uk/schedule/",
  },
  {
    id: "cine-lumiere",
    name: "Ciné Lumière",
  ...
  },
  {
    ...
    chain: null,
    scraperType: "api",
    scraperModule: "cinemas/electric-v2",
    scraperFactory: "createElectricScraperV2",
    active: true,
  ...
  },
  {
    ...
    website: "https://www.electriccinema.co.uk",
    address: { street: "Television Centre", area: "White City", postcode: "W12 7SL", borough: "Hammersmith and Fulham" },
    ...
    scraperFactory: "createElectricScraperV2",
    active: true,
    features: ["luxury", "bar", "accessible"],
    programmingFocus: ["mainstream", "arthouse"],
    description: "Luxury cinema at Television Centre with sofas, armchairs, and beds.",
    bookingUrl: "https://www.electriccinema.co.uk",
  },
  {
    id: "lexi",
  ...
  // Deptford Cinema has NO fixed address — the collective gave up its premises
  // in 2020 and runs as a pop-up. The address below is its current home (a
  // monthly residency at The Brookmill pub) and WILL go stale; a previous run
  // was at The Ivy House, Nunhead. Ignore the 39 Deptford Broadway address
  // still on the website — that's the vacated 2014-2020 shopfront.
  {
    id: "deptford-cinema",
    name: "Deptford Cinema",
    shortName: "Deptford",
    website: "https://deptfordcinema.org",
    address: { street: "65 Cranbrook Road", area: "Deptford", postcode: "SE8 4EJ", borough: "Lewisham" },
    coordinates: { lat: 51.4709, lng: -0.022 },
    screens: 1,
    chain: null,
    scraperType: "api",
    scraperModule: "external/lcut-gapfill",
  ...
  },
  {
    ...
    shortName: "Metroland",
    website: "https://metrolandcultures.com",
    address: { street: "91 Kilburn Square", area: "Kilburn", postcode: "NW6 6PS", borough: "Brent" },
    coordinates: { lat: 51.5386, lng: -0.1953 },
    screens: 1,
    chain: null,
    scraperType: "api",
    scraperModule: "external/lcut-gapfill",
    ...
    active: true,
    features: ["arts-centre", "community", "accessible"],
    programmingFocus: ["documentary", "repertory", "community", "events"],
    description: "Artist studios and gallery in Kilburn run by arts charity Metroland Cultures; home to the monthly Majlis Film Club and festival screenings.",
    bookingUrl: "https://metrolandcultures.com/events/",
  },
  {
    id: "set-social-peckham",
    name: "SET Social",
    shortName: "SET Social",
    website: "https://setspace.uk/social/",
    address: { street: "55a Nigel Road", area: "Peckham", postcode: "SE15 4NP", borough: "Southwark" },
    coordinates: { lat: 51.4663, lng: -0.068 },
    screens: 1,
    chain: null,
    scraperType: "api",
    scraperModule: "external/lcut-gapfill",
    scraperFactory: "lcutGapfill",
    active: true,
    features: ["bar", "cafe", "community", "accessible"],
    programmingFocus: ["experimental", "documentary", "community", "events"],
    description: "Not-for-profit arts and social club in Peckham run by the charity SET; hosts regular film nights and the annual SET Film Festival.",
    bookingUrl: "https://setspace.uk/events/",
  },
];
...
const CURZON_VENUES: CinemaDefinition[] = [
  ...
  },
  {
    ...
    address: { street: "Hawley Wharf", area: "Camden", postcode: "NW1 8QP", borough: "Camden" },
    coordinates: { lat: 51.5413, lng: -0.1450 },
    screens: 5,
    chain: "curzon",
    chainVenueId: "CAM1",
    chainSlug: "camden",
  ...
  },
  {
    ...
    website: "https://www.curzon.com/venues/richmond/",
    address: { street: "3 Water Lane", area: "Richmond", postcode: "TW9 1NE", borough: "Richmond upon Thames" },
    coordinates: { lat: 51.4598, lng: -0.3060 },
    screens: 3,
    chain: "curzon",
    chainVenueId: "RIC1",
    chainSlug: "richmond",
  ...
  },
  {
    ...
    address: { street: "23 The Broadway", area: "Wimbledon", postcode: "SW19 8YA", borough: "Merton" },
    coordinates: { lat: 51.4214, lng: -0.2066 },
    screens: 3,
    chain: "curzon",
    chainVenueId: "WIM1",
    chainSlug: "wimbledon",
...
const EVERYMAN_VENUES: CinemaDefinition[] = [
  ...
  },
  {
    ...
    website: "https://www.everymancinema.com/venues-list/g049a-everyman-brentford",
    address: { street: "Brentford Project, Catherine Wheel Road", area: "Brentford", postcode: "TW8 8GR", borough: "Hounslow" },
    screens: 3,
    chain: "everyman",
    chainVenueId: "G049A",
    chainSlug: "brentford",
  ...
  },
  {
    ...
    website: "https://www.everymancinema.com/venues-list/g05d7-everyman-at-the-whiteley",
    address: { street: "The Whiteley, Porchester Gardens", area: "Bayswater", postcode: "W2 4YN", borough: "Westminster" },
    screens: 5,
    chain: "everyman",
    chainVenueId: "G05D7",
    chainSlug: "the-whiteley",
    scraperType: "playwright",
    scraperModule: "chains/everyman",
    scraperFactory: "createEverymanScraper",
    active: true,
